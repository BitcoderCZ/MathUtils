...
public sealed class FunctionPart : IPart
{
	...
	private readonly Func<IList<IPart>, CalculationSettings, double> func;

	public FunctionPart(string _name, IList<IPart> _params, Func<IList<IPart>, CalculationSettings, double> _func)
	{
		Name = _name;
		Params = _params;
		func = _func;
