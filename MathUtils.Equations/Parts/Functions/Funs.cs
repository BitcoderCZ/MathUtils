...
{
	public static IEnumerable<FunctionDefinition> AllFunctions =
	[
		Abs,
		Min,
		Max,
	...
	public static FunctionDefinition Sin => new FunctionDefinition("sin", 1, (parts, content) => Math.Sin(Measures.Measures.Angle.Convert(parts[0].GetValue(content), content.AngleUnit, Units.Angles.Radian)));
	public static FunctionDefinition Cos => new FunctionDefinition("cos", 1, (parts, content) => Math.Cos(Measures.Measures.Angle.Convert(parts[0].GetValue(content), content.AngleUnit, Units.Angles.Radian)));
	public static FunctionDefinition Tan => new FunctionDefinition("tan", 1, (parts, content) => Math.Tan(Measures.Measures.Angle.Convert(parts[0].GetValue(content), content.AngleUnit, Units.Angles.Radian)));
}
